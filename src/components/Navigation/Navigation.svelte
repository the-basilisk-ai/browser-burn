...
<nav class="flex grow justify-end" style:color={themeValue.textBrand}>
  <div
    class="flex rounded-md p-2 pl-3 pr-3 space-x-2"
  ...
  >
    ...
    <button
      ...
      class="cursor-pointer border-l border-l-2 pl-3"
